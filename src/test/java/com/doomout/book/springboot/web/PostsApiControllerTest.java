...
public class PostsApiControllerTest {
    ...
    @Before // 매번 테스트가 시작되기 전에 McokMvc 인스턴스를 생성한다.
    public void setup() {
        mvc = MockMvcBuilders
    ...
    @Test
    @WithMockUser(roles="USER") // 인증된 모의 사용자를 만들어 사용, roles 에 권한을 추가할 수 있다.
    public void Posts_등록된다() throws Exception {
        ...
        //when
        // 생성된 MockMvc 를 통해 API 를 테스트 한다
        // 본문 영역은 만자열로 표현하기 위해 ObjectMapper 를 통해 문자열 JSON 으로 변환한다.
